...
class LoggingVolumeApi(object):
    ...
    def create_logging_volume(self, cluster_name, logging_volume_payload, **kwargs):  # noqa: E501
    ...
    def create_logging_volume_with_http_info(self, cluster_name, logging_volume_payload, **kwargs):  # noqa: E501
        """Creates a new Logging Volume  # noqa: E501
    ...
    def delete_logging_volume(self, cluster_name, name, **kwargs):  # noqa: E501
    ...
    def delete_logging_volume_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Deletes a single LoggingVolume  # noqa: E501
    ...
    def get_logging_volume(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single LoggingVolume by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logging_volume(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_logging_volume_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single LoggingVolume by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logging_volume_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_logging_volume" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_logging_volume`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_logging_volume`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/logging_volumes/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_logging_volumes(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of LoggingVolume objects. Supports paging  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logging_volumes(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_logging_volumes_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of LoggingVolume objects. Supports paging  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logging_volumes_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_logging_volumes" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_logging_volumes`")  # noqa: E501

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `get_logging_volumes`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_logging_volumes`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_logging_volumes`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/logging_volumes', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
