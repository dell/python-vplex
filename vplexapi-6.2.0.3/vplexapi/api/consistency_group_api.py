...
class ConsistencyGroupApi(object):
    ...
    def patch_consistency_group(self, cluster_name, name, consistency_group_patch_payload, **kwargs):  # noqa: E501
        ...
        Patchable attributes:   * detach_rule (replace)     * {\"type\": winner\", \"cluster\": <cluster_uri>, \"delay\": <delay_in_seconds>}     * {\"type\": \"no_automatic_winner\"}   * name (replace)   * recoverpoint_enabled (replace)   * storage_at_clusters (add/remove)   * virtual_volumes (add/remove)   * visibility (add/remove)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
