...
class ConsistencyGroupApi(object):
    ...
    def create_consistency_group(self, cluster_name, consistency_group_payload, **kwargs):  # noqa: E501
    ...
    def create_consistency_group_with_http_info(self, cluster_name, consistency_group_payload, **kwargs):  # noqa: E501
        """Create a new ConsistencyGroup  # noqa: E501
    ...
    def delete_consistency_group(self, cluster_name, name, **kwargs):  # noqa: E501
    ...
    def delete_consistency_group_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Deletes a single ConsistencyGroup  # noqa: E501
    ...
    def get_consistency_group(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single ConsistencyGroup object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_consistency_group(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_consistency_group_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single ConsistencyGroup object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_consistency_group_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_consistency_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_consistency_group`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_consistency_group`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/consistency_groups/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_consistency_groups(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of ConsistencyGroups  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_consistency_groups(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_consistency_groups_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of ConsistencyGroups  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_consistency_groups_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_consistency_groups`")  # noqa: E501

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `get_consistency_groups`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_consistency_groups`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_consistency_groups`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/consistency_groups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_consistency_group(self, cluster_name, name, consistency_group_patch_payload, **kwargs):  # noqa: E501
        """Update attributes on a ConsistencyGroup  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_consistency_group(cluster_name, name, consistency_group_patch_payload, async_req=True)
        >>> result = thread.get()
    ...
    def patch_consistency_group_with_http_info(self, cluster_name, name, consistency_group_patch_payload, **kwargs):  # noqa: E501
        """Update attributes on a ConsistencyGroup  # noqa: E501

        Patchable attributes:   * detach_rule (replace)     * {\"type\": winner\", \"cluster\": <cluster_uri>, \"delay\": <delay_in_seconds>}     * {\"type\": \"no_automatic_winner\"}   * name (replace)   * storage_at_clusters (add/remove)   * virtual_volumes (add/remove)   * visibility (add/remove)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_consistency_group_with_http_info(cluster_name, name, consistency_group_patch_payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_consistency_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `patch_consistency_group`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `patch_consistency_group`")  # noqa: E501
        # verify the required parameter 'consistency_group_patch_payload' is set
        if ('consistency_group_patch_payload' not in params or
                params['consistency_group_patch_payload'] is None):
            raise ValueError("Missing the required parameter `consistency_group_patch_payload` when calling `patch_consistency_group`")  # noqa: E501
        ...
        body_params = None
        if 'consistency_group_patch_payload' in params:
            body_params = params['consistency_group_patch_payload']
        # Authentication setting
        auth_settings = ['basicAuth', 'jwtAuth']  # noqa: E501

        return self.api_client.call_api(
            '/clusters/{cluster_name}/consistency_groups/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
