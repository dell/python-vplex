...
class HealthApi(object):
    ...
    def get_local_com_health(self, cluster_name, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_local_com_health(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_local_com_health_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_local_com_health_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_wan_com_health(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_wan_com_health(async_req=True)
        >>> result = thread.get()
    ...
    def get_wan_com_health_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_wan_com_health_with_http_info(async_req=True)
        >>> result = thread.get()
