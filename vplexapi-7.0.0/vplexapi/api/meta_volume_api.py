...
class MetaVolumeApi(object):
    ...
    def get_meta_volume(self, cluster_name, name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_meta_volume(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_meta_volume_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_meta_volume_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_meta_volumes(self, cluster_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_meta_volumes(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_meta_volumes_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_meta_volumes_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
