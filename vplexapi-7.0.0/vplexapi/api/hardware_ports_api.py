...
class HardwarePortsApi(object):
    ...
    def get_hardware_ports(self, **kwargs):  # noqa: E501
        """Returns a list of hardware ports  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hardware_ports(async_req=True)
        >>> result = thread.get()
        ...
        :param str director: Filter results by director. See LexicalQueryExpression for details.
        :param str status: Filter results by status. See LexicalQueryExpression for details.
        :param str role: Filter results by role. See LexicalQueryExpression for details.
    ...
    def get_hardware_ports_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a list of hardware ports  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hardware_ports_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_hardware_ports" % key
                )
            params[key] = val
        del params['kwargs']

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `get_hardware_ports`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_hardware_ports`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_hardware_ports`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'director' in params:
            query_params.append(('director', params['director']))  # noqa: E501
        if 'status' in params:
