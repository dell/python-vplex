...
class StorageArrayApi(object):
    ...
    def get_name_mapping(self, cluster_name, name, **kwargs):  # noqa: E501
        """Get the default name mapping for claimable volumes on this array  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_name_mapping(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_name_mapping_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Get the default name mapping for claimable volumes on this array  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_name_mapping_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_name_mapping" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('cluster_name' not in params or
            ...
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_name_mapping`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_name_mapping`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/storage_arrays/{name}/name_mapping', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_storage_array(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single StorageArray by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_array(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_storage_array_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Returns a single StorageArray by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_array_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_array" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_storage_array`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_storage_array`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/storage_arrays/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_storage_arrays(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of StorageArrays  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_arrays(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_storage_arrays_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        """Returns a list of StorageArrays  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_arrays_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_arrays" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params or
                params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_storage_arrays`")  # noqa: E501

        if 'offset' in params and params['offset'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `offset` when calling `get_storage_arrays`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_storage_arrays`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_storage_arrays`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'logical_unit_count' in params:
            query_params.append(('logical_unit_count', params['logical_unit_count']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clusters/{cluster_name}/storage_arrays', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def rediscover_storage_array(self, cluster_name, name, **kwargs):  # noqa: E501
    ...
    def rediscover_storage_array_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        """Rediscover LUNs on the array  # noqa: E501
