...
class AmpApi(object):
    ...
    def get_array_management_provider(self, cluster_name, name, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_array_management_provider(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_array_management_provider_with_http_info(self, cluster_name, name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_array_management_provider_with_http_info(cluster_name, name, async_req=True)
        >>> result = thread.get()
    ...
    def get_array_management_providers(self, cluster_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_array_management_providers(cluster_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_array_management_providers_with_http_info(self, cluster_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_array_management_providers_with_http_info(cluster_name, async_req=True)
        >>> result = thread.get()
